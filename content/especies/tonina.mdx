---
nombre_comun: "Tonina"
nombre_cientifico: "Tursiops truncatus gephyreus"
resumen: "Quién es la tonina (Tursiops truncatus gephyreus), el delfín costero de Uruguay: dónde vive, cuántos quedan, cómo se comunica y por qué está en peligro."
resumen_en: "Lahille's bottlenose dolphin (Tursiops truncatus gephyreus), the coastal dolphin of Uruguay."
orden: 0
body_en: |
  The tonina, or Lahille's bottlenose dolphin (***Tursiops truncatus gephyreus***),
  ...
  ## What do we know about the ecology and behaviour of toninas in Uruguay?
...
## Qué sabemos de la ecología y el comportamiento de las toninas en Uruguay?
