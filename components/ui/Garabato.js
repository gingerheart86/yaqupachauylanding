...
// Piezas sueltas de garabatos.png (mandalas, estrellas, espirales de
// Yez) - ver docs/fase2-assets-yez.md seccion 3. Nombradas de forma
// generica: no se pudo confirmar visualmente cual pieza es cual.
const GARABATOS = {
  ...
  5: { src: "/decor/garabatos/garabato-5.png", width: 373, height: 169 },
};
