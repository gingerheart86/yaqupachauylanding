...
// TODO: falta la URL del web map de ArcGIS para /avistamientos (capa
// publica que combina las respuestas del Survey123 con los
// avistamientos propios). docs/correcciones-revision-local.md punto 7.
// No inventar la URL - mientras falte, la pagina muestra un aviso en
// vez de un iframe vacio.
//
// ANTES DE CARGAR LA URL REAL: verificar que la capa publica del mapa
// NO exponga el celular ni el correo de quien reporta. El formulario
// Survey123 los pide, pero esos dos campos no pueden ser visibles en
// la capa que se embebe aca.
export const ARCGIS_WEBMAP_URL = null;
