...
export default function Home() {
  return (
    <Section fondo="claro">
      <PageHeader eyebrow="Proyecto Toninas" title="Antecedentes" />
      <div className="mt-8">
        ...
        <h2 className="mt-8 block text-center text-3xl font-semibold tracking-tight text-mar-800 sm:text-4xl">
